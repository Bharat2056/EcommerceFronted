            ...
            <div className="bg-[#f1f1f1] p-2 w-full mb-4 rounded-md flex items-center justify-between">
              ...
              <div className="col2 ml-auto flex items-center justify-end gap-3 pr-4">
                ...
                <Button
                  ...
                  onClick={handleClick}
                  className="!bg-[#fff] !text-[#000] !text-[15px] !capitalize !border-2 !border-[#000]"
                >
                  Dashboard
                </Button>
                ...
                >
                  <MenuItem
                    onClick={handleClose}
                    className=" !text-[#000] !text-[15px] !capitalize "
                  >
...
<div className={`grid ${itemView === 'grid' ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-1'} gap-4`}>
              {itemView === "grid" ? (
                <>
                  <ProductItem />
                  <ProductItem />
